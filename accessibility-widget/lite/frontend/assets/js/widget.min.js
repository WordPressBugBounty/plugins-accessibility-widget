...
`;var Ci={status:{mobile:!0,desktop:!0},iconId:"accessibility",iconSize:48,label:"Accessibility widget",heading:"Accessibility menu",position:{mobile:"bottom-right",desktop:"bottom-right"},language:{default:"en",selected:[]},margins:{desktop:{top:20,bottom:20,left:20,right:20},mobile:{top:20,bottom:20,left:20,right:20}},primaryColor:"#1863DC",modules:{color:{darkContrast:{enabled:!1},lightContrast:{enabled:!1},highContrast:{enabled:!1},highSaturation:{enabled:!1},lightSaturation:{enabled:!1},monochrome:{enabled:!1}},content:{highlightText:{enabled:!1},highlightLinks:{enabled:!1},dyslexicFont:{enabled:!0},letterSpacing:{enabled:!1},lineHeight:{enabled:!0},fontWeight:{enabled:!1}},statement:{enabled:!1,url:""}}},p=window._cyA11yConfig||Ci;function G(){let e=w.style.display!=="none",t=w.getRootNode().querySelector(".cya11y-overlay");if(String(w.style.display)!=="none"||e){w.style.display="none",t.style.display="none",w._escapeKeyHandler&&(document.removeEventListener("keydown",w._escapeKeyHandler),delete w._escapeKeyHandler);let a=document.querySelector(".cya11y-container");if(a){let o=a.shadowRoot;if(o){let n=o.querySelector(".cya11y-menu-btn");n&&n.setAttribute("aria-expanded","false")}}}else{w.style.display="block",t.style.display="block";let a=document.querySelector(".cya11y-container");if(a){let o=a.shadowRoot;if(o){let n=o.querySelector(".cya11y-menu-btn");n&&n.setAttribute("aria-expanded","true")}}}}var X={"seizure-safe-profile":{contrast:"low-saturation",tools:["stop-animations"]},"adhd-profile":{contrast:"high-saturation",tools:["stop-animations","readable-guide"]},"cognitive-disabilities-profile":{tools:["stop-animations","highlight-links","highlight-title"]}};function R(e){let i=l.states;if(i){let t=Array.from(e.querySelectorAll(".cya11y-btn"));Object.entries(i).forEach(([a,o])=>{if(o&&a!=="fontSize"){let n=a==="contrast"?i[a]:a,u=t.find(h=>h.dataset.key===n);u&&u.classList.add("cya11y-selected")}else{let n=t.find(u=>u.dataset.key===a);n&&n.classList.remove("cya11y-selected"),a==="contrast"&&e.querySelectorAll(".cya11y-filter").forEach(h=>{h.classList.remove("cya11y-selected")})}})}}function fe(e,i){let t=X[e];t&&(l.states.contrast=t.contrast,E(t.contrast),t.tools.forEach(a=>{l.states[a]=!0}),L(),A(),R(i))}function W(){document.getElementById("cya11y-filter-style")?.remove(),document.documentElement.classList.remove("cya11y-filter")}function Q(e,i){let t=X[e];W(),l.states.contrast=!1,t.tools.forEach(a=>{l.states[a]=!1,L()}),A(),R(i)}var u2=Fe({"../locales/am.json":()=>Promise.resolve().then(()=>r(yt())),"../locales/ar.json":()=>Promise.resolve().then(()=>r(Ct())),"../locales/bg.json":()=>Promise.resolve().then(()=>r(pt())),"../locales/bn.json":()=>Promise.resolve().then(()=>r(mt())),"../locales/ca.json":()=>Promise.resolve().then(()=>r(ht())),"../locales/cs.json":()=>Promise.resolve().then(()=>r(ft())),"../locales/da.json":()=>Promise.resolve().then(()=>r(bt())),"../locales/de.json":()=>Promise.resolve().then(()=>r(Lt())),"../locales/el.json":()=>Promise.resolve().then(()=>r(St())),"../locales/en.json":()=>Promise.resolve().then(()=>r(vt())),"../locales/es.json":()=>Promise.resolve().then(()=>r(wt())),"../locales/fa.json":()=>Promise.resolve().then(()=>r(kt())),"../locales/fi.json":()=>Promise.resolve().then(()=>r(xt())),"../locales/fil.json":()=>Promise.resolve().then(()=>r(At())),"../locales/fr.json":()=>Promise.resolve().then(()=>r(Ht())),"../locales/he.json":()=>Promise.resolve().then(()=>r(Ft())),"../locales/hi.json":()=>Promise.resolve().then(()=>r(Mt())),"../locales/hr.json":()=>Promise.resolve().then(()=>r(zt())),"../locales/hu.json":()=>Promise.resolve().then(()=>r(jt())),"../locales/id.json":()=>Promise.resolve().then(()=>r(Tt())),"../locales/it.json":()=>Promise.resolve().then(()=>r(Dt())),"../locales/ja.json":()=>Promise.resolve().then(()=>r(Et())),"../locales/ka.json":()=>Promise.resolve().then(()=>r(Rt())),"../locales/kn.json":()=>Promise.resolve().then(()=>r(It())),"../locales/ko.json":()=>Promise.resolve().then(()=>r(Pt())),"../locales/ku.json":()=>Promise.resolve().then(()=>r(Zt())),"../locales/lb.json":()=>Promise.resolve().then(()=>r(Vt())),"../locales/ml.json":()=>Promise.resolve().then(()=>r(Bt())),"../locales/mn.json":()=>Promise.resolve().then(()=>r(Nt())),"../locales/ms.json":()=>Promise.resolve().then(()=>r(Gt())),"../locales/my.json":()=>Promise.resolve().then(()=>r(Ot())),"../locales/nl.json":()=>Promise.resolve().then(()=>r(_t())),"../locales/no.json":()=>Promise.resolve().then(()=>r(Kt())),"../locales/pa.json":()=>Promise.resolve().then(()=>r($t())),"../locales/pl.json":()=>Promise.resolve().then(()=>r(Wt())),"../locales/pt.json":()=>Promise.resolve().then(()=>r(qt())),"../locales/ro.json":()=>Promise.resolve().then(()=>r(Ut())),"../locales/ru.json":()=>Promise.resolve().then(()=>r(Yt())),"../locales/si.json":()=>Promise.resolve().then(()=>r(Jt())),"../locales/sk.json":()=>Promise.resolve().then(()=>r(Xt())),"../locales/sl.json":()=>Promise.resolve().then(()=>r(Qt())),"../locales/sr.json":()=>Promise.resolve().then(()=>r(e1())),"../locales/sv.json":()=>Promise.resolve().then(()=>r(t1())),"../locales/sw.json":()=>Promise.resolve().then(()=>r(i1())),"../locales/ta.json":()=>Promise.resolve().then(()=>r(a1())),"../locales/te.json":()=>Promise.resolve().then(()=>r(o1())),"../locales/th.json":()=>Promise.resolve().then(()=>r(n1())),"../locales/tr.json":()=>Promise.resolve().then(()=>r(s1())),"../locales/ur.json":()=>Promise.resolve().then(()=>r(r1())),"../locales/vi.json":()=>Promise.resolve().then(()=>r(l1())),"../locales/zh.json":()=>Promise.resolve().then(()=>r(c1()))});var H=[{code:"am",label:"\u12A0\u121B\u122D\u129B (Amharic)"},{code:"ar",label:"\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (Arabic)"},{code:"bg",label:"\u0431\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438 (Bulgarian)"},{code:"bn",label:"\u09AC\u09BE\u0982\u09B2\u09BE (Bengali)"},{code:"ca",label:"Catal\xE0 (Catalan)"},{code:"cs",label:"\u010De\u0161tina (Czech)"},{code:"da",label:"Danish (Denmark)"},{code:"de",label:"Deutsch (German)"},{code:"el",label:"\u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC (Greek)"},{code:"en",label:"English (English)"},{code:"es",label:"Espa\xF1ol (Spanish)"},{code:"fa",label:"\u0641\u0627\u0631\u0633\u06CC (Persian)"},{code:"fi",label:"suomi (Finnish)"},{code:"fil",label:"Tagalog (Filipno)"},{code:"fr",label:"Fran\xE7ais (French)"},{code:"he",label:"\u05E2\u05D1\u05E8\u05D9\u05EA (Hebrew)"},{code:"hi",label:"\u0939\u093F\u0928\u094D\u0926\u0940 (Hindi)"},{code:"hr",label:"Hrvatski (Croatian)"},{code:"hu",label:"Magyar (Hungarian)"},{code:"id",label:"Bahasa Indonesia (Indonesian)"},{code:"it",label:"Italiano (Italian)"},{code:"ja",label:"\u65E5\u672C\u8A9E (Japanese)"},{code:"ka",label:"\u10E5\u10D0\u10E0\u10D7\u10E3\u10DA\u10D8 (Georgian)"},{code:"kn",label:"\u0C95\u0CA8\u0CCD\u0CA8\u0CA1 (Kannada)"},{code:"ko",label:"\uD55C\uAD6D\uC5B4 (Korean)"},{code:"ku",label:"Kurd\xEE (Kurdish)"},{code:"lb",label:"L\xEBtzebuergesch (Luxembourgish)"},{code:"ml",label:"\u0D2E\u0D32\u0D2F\u0D3E\u0D33\u0D02 (Malayalam)"},{code:"mn",label:"\u041C\u043E\u043D\u0433\u043E\u043B (Mongolian)"},{code:"ms",label:"Bahasa Malaysia (Malay)"},{code:"my",label:"\u1019\u103C\u1014\u103A\u1019\u102C (Burmese)"},{code:"nl",label:"Nederlands (Dutch)"},{code:"no",label:"Norsk (Norwegian)"},{code:"pa",label:"\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40 (Punjabi)"},{code:"pl",label:"Polski (Polish)"},{code:"pt",label:"Portugu\xEAs (Portuguese)"},{code:"ro",label:"Rom\xE2n\u0103 (Romanian)"},{code:"ru",label:"\u0420\u0443\u0441\u0441\u043A\u0438\u0439 (Russian)"},{code:"si",label:"Sloven\u0161\u010Dina (Slovene)"},{code:"sk",label:"sloven\u010Dina (Slovak)"},{code:"sl",label:"sloven\u0161\u010Dina (Slovenian)"},{code:"sr",label:"Srpski (Serbian)"},{code:"sv",label:"Svenska (Swedish)"},{code:"sw",label:"Kiswahili (Swahili)"},{code:"ta",label:"\u0BA4\u0BAE\u0BBF\u0BB4\u0BCD (Tamil)"},{code:"te",label:"\u0C24\u0C46\u0C32\u0C41\u0C17\u0C41 (Telugu)"},{code:"th",label:"\u0E44\u0E17\u0E22 (Thai)"},{code:"tr",label:"T\xFCrk\xE7e (Turkish)"},{code:"ur",label:"\u0627\u0631\u062F\u0648 (Urdu)"},{code:"vi",label:"Ti\u1EBFng Vi\u1EC7t (Vietnamese)"}],y2=H.map(e=>e.code),ee={};async function C2(){for(let e of y2)ee[e]=(await u2(`../locales/${e}.json`)).default}C2();function g1(e){return(ee[l.lang]??ee[p.language.default])[e]??e}function d1(e,i){let t=e.getAttribute("data-translate")||i;return!e.hasAttribute("data-translate")&&i&&e.setAttribute("data-translate",t),g1(t)}function q(e){e.querySelectorAll(".cya11y-card-title, .cya11y-translate").forEach(i=>{let t=i.textContent?.trim()||"";i.textContent=d1(i,t)}),k.querySelectorAll("[title]").forEach(i=>{let t=i.getAttribute("title")||"";i.setAttribute("title",d1(i,t))})}function F(e,i){if(e=String(e||"").toLowerCase(),H.some(t=>t.code===e)||(e=p.language.default),l.lang!==e){l.lang=e;let t=i.querySelector("#cya11y-language");t&&(t.value=e),q(i),L()}}var u1='<svg viewbox="0 0 24 24" fill=none height=24 width=24 xmlns=http://www.w3.org/2000/svg><path d="M18 9L12 15L6 9" stroke=black stroke-linecap=round stroke-linejoin=round stroke-width=2 /></svg>';function te(e){if(!e||typeof e!="string")return console.warn("Invalid attribute name provided to getScriptDataAttribute:",e),null;let i=`data-cya11y-${e}`;try{let t=document.currentScript;return t?.hasAttribute(i)?t.getAttribute(i):document.querySelector(`[${i}]`)?.getAttribute(i)||null}catch(t){return console.error("Error getting script data attribute:",t),null}}function I(){let i=(te("lang")||document.documentElement?.lang||navigator?.language||document.querySelector('meta[http-equiv="Content-Language"]')?.content)?.split(/[-_]/)?.[0]?.trim()||p.language.default;return H.some(a=>a.code===i)?i:p.language.default}H.some(e=>e.code===l.lang)||(l.lang=I());var U=!1,_=null;function O(e,i=""){let t=e.querySelector("#cya11y-language-dropdown"),a=H.filter(c=>c.label.toLowerCase().includes(i.toLowerCase())||c.code.toLowerCase().includes(i.toLowerCase())),o=a.findIndex(c=>c.code===l.lang);t.innerHTML=`
  ...
  `;let n=t.querySelector(".cya11y-selected-lang"),u=t.querySelector(".cya11y-dropdown-list"),h=t.querySelector(".cya11y-lang-search"),x=u.querySelector(".cya11y-lang-options"),V=o>=0?o:0;n.onclick=c=>{c.stopPropagation(),U?(P(t),n.querySelector(".cya11y-arrow")?.classList.remove("cya11y-arrow-rotate")):(be(t),n.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),h?.focus())},n.onkeydown=c=>{(c.key==="Enter"||c.key===" "||c.key==="ArrowDown")&&(c.preventDefault(),be(t),n.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),setTimeout(()=>h?.focus(),0))},h?.addEventListener("input",c=>{let m=h.value,v=t.querySelector(".cya11y-dropdown-list").querySelector(".cya11y-lang-options"),g=H.filter(d=>d.label.toLowerCase().includes(m.toLowerCase())||d.code.toLowerCase().includes(m.toLowerCase()));v.innerHTML=g.map((d,y)=>`
    ...
    `).join(""),Array.from(v.querySelectorAll(".cya11y-lang-option")).forEach((d,y)=>{d.onclick=B=>{B.stopPropagation(),F(d.dataset.code,e),P(t),O(e),n.focus()}})}),h?.addEventListener("keydown",c=>{if(c.key==="ArrowDown"){c.preventDefault();let m=Array.from(t.querySelectorAll(".cya11y-lang-option"));m[0].focus(),m.forEach((f,v)=>{f.addEventListener("keydown",g=>{g.key==="ArrowDown"?(g.preventDefault(),v<m.length-1&&m[v+1].focus()):g.key==="ArrowUp"?(g.preventDefault(),v>0?m[v-1].focus():h.focus()):g.key==="Enter"||g.key===" "?(g.preventDefault(),F(f.dataset.code,e),P(t),O(e),n.focus()):g.key==="Escape"&&(P(t),n.focus())})})}});let S=Array.from(t.querySelectorAll(".cya11y-lang-option"));S.forEach((c,m)=>{c.addEventListener("focus",()=>{c.setAttribute("aria-selected","true"),S.forEach(f=>{f!==c&&f.setAttribute("aria-selected","false")})}),c.addEventListener("click",()=>{F(c.dataset.code,e),P(t),O(e),n.focus()}),c.addEventListener("keydown",f=>{f.key==="ArrowDown"?(f.preventDefault(),m<S.length-1&&S[m+1].focus()):f.key==="ArrowUp"?(f.preventDefault(),m>0?S[m-1].focus():h.focus()):f.key==="Enter"||f.key===" "?(f.preventDefault(),F(c.dataset.code,e),P(t),O(e),n.focus()):f.key==="Escape"&&(P(t),n.focus())})}),h?.addEventListener("focus",()=>{be(t)})}function P(e){let i=e.querySelector(".cya11y-dropdown-list"),t=e.querySelector(".cya11y-selected-lang");i&&(i.style.display="none"),t.querySelector(".cya11y-arrow")?.classList.remove("cya11y-arrow-rotate"),U=!1,_&&(document.removeEventListener("mousedown",_),_=null)}function be(e){let i=e.querySelector(".cya11y-dropdown-list"),t=e.querySelector(".cya11y-selected-lang");i&&(i.style.display="block"),t.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),U=!0,_||(_=a=>{e.contains(a.target)},document.addEventListener("mousedown",_))}function m2(){return window.innerWidth<768}function Y(){return m2()?"mobile":"desktop"}function Le(e){let i=e.querySelectorAll('a[href], button:not([disabled]), textarea, input, select, [tabindex]:not([tabindex="-1"])'),t=i[0],a=i[i.length-1],o=()=>{let n=e.getRootNode();return n instanceof ShadowRoot?n.activeElement:document.activeElement};e.addEventListener("keydown",function(n){if(n.key==="Tab"){let u=o();n.shiftKey?u===t&&(n.preventDefault(),a.focus()):u===a&&(n.preventDefault(),t.focus())}})}function z(e){let i=document.getElementById("cya11y-menu-announcements");i&&(i.textContent=e,setTimeout(()=>{i.textContent=""},1e3))}function Z(e,i){e.setAttribute("aria-pressed",i.toString()),i?e.classList.add("cya11y-selected"):e.classList.remove("cya11y-selected")}function h2(e,i){let t=Array.from(i.parentElement?.querySelectorAll(".cya11y-btn")||[]),a=t.indexOf(i);switch(e.key){case"ArrowRight":case"ArrowDown":e.preventDefault();let o=(a+1)%t.length;t[o]?.focus();break;case"ArrowLeft":case"ArrowUp":e.preventDefault();let n=a===0?t.length-1:a-1;t[n]?.focus();break;case"Home":e.preventDefault(),t[0]?.focus();break;case"End":e.preventDefault(),t[t.length-1]?.focus();break}}function Se(){let e=Y(),i=document.createElement("div");i.innerHTML=`<style id="cya11y-menu-css">${ut}</style>`+Ne;let t=i.querySelector(".cya11y-menu"),a=p?.position[e];a&&(t.setAttribute("data-position",a),a.includes("right")?(t.style.right="0px",t.style.left="auto"):a.includes("left")&&(t.style.left="0px",t.style.right="auto"));let o=g=>{g.key==="Escape"&&(g.preventDefault(),g.stopPropagation(),G(),document.removeEventListener("keydown",o))};document.addEventListener("keydown",o),t._escapeKeyHandler=o;let n=t.querySelector(".content"),u=t.querySelector(".tools"),h=t.querySelector(".contrast"),x=t.querySelector(".profiles");n&&(n.innerHTML=N(at)),u&&(u.innerHTML=N(rt,"cya11y-tools")),h&&(h.innerHTML=N(qe,"cya11y-filter")),x&&(x.innerHTML=N(dt,"cya11y-profile"));let V=t.querySelector(".cya11y-profile-card"),S=t.querySelector(".cya11y-profile-title"),c=t.querySelector(".cya11y-profile-items");c&&(c.style.display="none"),S&&S.addEventListener("click",()=>{let g=t.querySelector(".cya11y-profile-items"),C=g.style.display!=="none";g.style.display=C?"none":"grid",S.setAttribute("aria-expanded",(!C).toString()),V.querySelector(".cya11y-arrow")?.classList.toggle("cya11y-arrow-rotate"),z(C?"Accessibility profiles collapsed":"Accessibility profiles expanded")}),V.remove();let m=l?.states,f=Number(m?.fontSize)||1;if(f!=1){let g=t.querySelector(".cya11y-amount");g&&(g.innerHTML=`${(f*100).toFixed(0)}%`)}R(t),O(t);let v=i.querySelector(".cya11y-accessibility-statement-link");return v&&(p.modules.statement.enabled?(v.href=p.modules.statement.url||"#",v.style.display="block"):v.style.display="none"),i.querySelectorAll(".cya11y-menu-close, .cya11y-overlay").forEach(g=>g.addEventListener("click",G)),i.querySelectorAll(".cya11y-menu-reset").forEach(g=>g.addEventListener("click",()=>{he(t),z("All accessibility settings have been reset to default")})),t.querySelectorAll(".cya11y-plus, .cya11y-minus").forEach(g=>{let C=g;C.addEventListener("click",()=>{let y=l?.states?.fontSize||1;C.classList.contains("cya11y-minus")?y-=.1:y+=.1,y=Math.max(y,.1),y=Math.min(y,2),y=Number(y.toFixed(2));let B=i.querySelector(".cya11y-amount");B&&(B.textContent=`${(y*100).toFixed(0)}%`),D(y),l.states.fontSize=y,L(),z(`Font size set to ${(y*100).toFixed(0)}%`)})}),t.querySelectorAll(".cya11y-btn").forEach(g=>{let C=g;C.addEventListener("keydown",d=>{h2(d,C)}),C.addEventListener("click",()=>{let d=C.dataset.key;if(!d)return;let y=!C.classList.contains("cya11y-selected");if(C.classList.contains("cya11y-filter")){if(t.querySelectorAll(".cya11y-filter").forEach(j=>{Z(j,!1)}),y&&Z(C,!0),l.states.contrast===d){l.states.contrast=!1,L(),W(),z("Contrast filter disabled");return}l.states.contrast=y?d:!1,E(l.states.contrast),L(),A(),Z(C,y);let ie=C.querySelector(".cya11y-translate")?.textContent||d;z(`${ie} contrast enabled`);return}if(C.classList.contains("cya11y-profile")){if(t.querySelectorAll(".cya11y-profile").forEach(j=>{Z(j,!1)}),y&&Z(C,!0),l.states[d]){l.states[d]=!1,L(),Q(d,t),z(`${d} profile disabled`);return}Object.keys(l.states).forEach(j=>{j.includes("profile")&&(l.states[j]=!1,L(),Q(j,t))}),L(),l.states[d]=!0,fe(d,t),L(),A(),Z(C,y);let ie=C.querySelector(".cya11y-translate")?.textContent||d;z(`${ie} profile enabled`)}Z(C,y),l.states[d]=y,A(),L();let B=C.querySelector(".cya11y-translate")?.textContent||d;z(`${B} ${y?"enabled":"disabled"}`)})}),k&&k.appendChild(i),Le(t),t}var w;function ve(){w?G():w=Se(),q(w)}var y1=`
   ...
   `;var C1=`<svg viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;var we=`
  ...
  >
   ...
   `;var p1=`<svg  viewBox="0 0 20 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
`;var f2=[{id:"default",icon:we},{id:"accessibility",icon:y1},{id:"assist",icon:C1},{id:"wheel",icon:p1}],k=null,m1={"bottom-right":e=>({bottom:`${e.bottom}px`,right:`${e.right}px`,left:"auto"}),"top-left":e=>({top:`${e.top}px`,left:`${e.left}px`,bottom:"auto"}),"top-right":e=>({top:`${e.top}px`,right:`${e.right}px`,left:"auto",bottom:"auto"}),"bottom-left":e=>({bottom:`${e.bottom}px`,left:`${e.left}px`})};function h1(){let e=Y(),{position:i,margins:t}=p,a=i[e],o=t[e],n=m1[a];return n?n(o):m1["bottom-left"](o)}function b2(e,i){switch(e.key){case"Enter":case" ":e.preventDefault(),ve();break;case"Escape":let t=document.querySelector(".cya11y-container");if(t){let a=t.shadowRoot;if(a){let o=a.querySelector(".cya11y-menu");if(o&&o.style.display!=="none"){let n=o.querySelector(".cya11y-menu-close");n&&(n.click(),i.setAttribute("aria-expanded","false"))}}}break}}function f1(){try{let e=Y();if(!(e==="mobile"?p.status.mobile:p.status.desktop))return console.log(`Widget disabled for ${e} device`),null;let t=document.createElement("div");t.classList.add("cya11y-container");let a=t.attachShadow({mode:"open"}),o=p.position[e],n=f2.find(x=>x.id===p.iconId);if(a.innerHTML=`
      <style id="cya11y-widget-css">${Be}</style>
      <div class="cya11y-widget" data-position="${o}">
        <div class="cya11y-widget-icon">
          ...
          <button 
             ...
             aria-label="${p.label||"Accessibility menu"}"
             aria-expanded="false"
    ...
    `,k=a.querySelector(".cya11y-widget"),!k)throw new Error("Failed to find widget element");k.style.setProperty("--cya11y-primary-color",p.primaryColor),k.style.setProperty("--cya11y-size",`${p.iconSize}px`);let u=k.querySelector(".cya11y-menu-btn"),h=k.querySelector(".cya11y-widget-icon");return u&&h&&(Object.assign(u.style,h1()),Object.assign(h.style,h1()),u.addEventListener("click",x=>{x.preventDefault(),x.stopPropagation(),x.stopImmediatePropagation(),ve(),setTimeout(()=>{let V=document.querySelector(".cya11y-container");if(V){let S=V.shadowRoot;if(S){let c=S.querySelector(".cya11y-menu");if(c){let m=c.style.display!=="none";u.setAttribute("aria-expanded",m.toString())}}}},10)}),u.addEventListener("keydown",x=>{b2(x,u)}),u.addEventListener("focus",()=>{u.classList.add("cya11y-focus-visible")}),u.addEventListener("blur",()=>{u.classList.remove("cya11y-focus-visible")})),document.body.insertBefore(t,document.body.firstChild),k}catch(e){return console.error("Failed to render widget:",e),null}}function ke(){try{let e=Ee();return console.log("Default language:",I()),Object.assign(l,e),l.lang||(l.lang=I()),$(),f1(),{changeLanguage:F}}catch(e){return console.error("Failed to initialize accessibility widget:",e),{changeLanguage:F}}}function xe(){try{let e=document.documentElement;if(!e){console.warn("HTML element not found, cannot observe lang attribute");return}let i=new MutationObserver(t=>{try{for(let a of t)if(a.type==="attributes"&&a.attributeName==="lang"){let o=I();F(o,!0)}}catch(a){console.error("Error handling lang attribute mutation:",a)}});i.observe(e,{attributes:!0,attributeFilter:["lang"]}),window.__cya11y__langObserver=i}catch(e){console.error("Failed to observe HTML lang attribute:",e)}}function Ae(){try{(document.readyState==="complete"||document.readyState==="interactive")&&(document.removeEventListener("readystatechange",Ae),ke(),te("disableObserveLang")||xe())}catch(e){console.error("Failed to initialize accessibility widget:",e)}}document.addEventListener("readystatechange",Ae);(document.readyState==="complete"||document.readyState==="interactive")&&Ae();})();
