...
`;function O(){let e=x.style.display!=="none",t=x.getRootNode().querySelector(".cya11y-overlay");if(String(x.style.display)!=="none"||e){x.style.display="none",t.style.display="none",x._escapeKeyHandler&&(document.removeEventListener("keydown",x._escapeKeyHandler),delete x._escapeKeyHandler);let a=document.querySelector("#cya11y-container");if(a){let n=a.shadowRoot;if(n){let o=n.querySelector(".cya11y-menu-btn");o&&o.setAttribute("aria-expanded","false")}}}else{x.style.display="block",t.style.display="block";let a=document.querySelector("#cya11y-container");if(a){let n=a.shadowRoot;if(n){let o=n.querySelector(".cya11y-menu-btn");o&&o.setAttribute("aria-expanded","true")}}}}var ae={"seizure-safe-profile":{contrast:"low-saturation",tools:["stop-animations"]},"adhd-profile":{contrast:"high-saturation",tools:["stop-animations","readable-guide"]},"cognitive-disabilities-profile":{tools:["stop-animations","highlight-links","highlight-title"]}};function P(e){let i=l.states;if(i){let t=Array.from(e.querySelectorAll(".cya11y-btn"));Object.entries(i).forEach(([a,n])=>{if(n&&a!=="fontSize"){let o=a==="contrast"?i[a]:a,y=t.find(m=>m.dataset.key===o);y&&y.classList.add("cya11y-selected")}else{let o=t.find(y=>y.dataset.key===a);o&&o.classList.remove("cya11y-selected"),a==="contrast"&&e.querySelectorAll(".cya11y-filter").forEach(m=>{m.classList.remove("cya11y-selected")})}})}}function ke(e,i){let t=ae[e];t&&(l.states.contrast=t.contrast,I(t.contrast),t.tools.forEach(a=>{l.states[a]=!0}),v(),H(),P(i))}function U(){document.getElementById("cya11y-filter-style")?.remove(),document.body.classList.remove("cya11y-filter","cya11y-dark-contrast")}function ne(e,i){let t=ae[e];U(),l.states.contrast=!1,t.tools.forEach(a=>{l.states[a]=!1,v()}),H(),P(i)}function wi(e,i){let t=e.getAttribute("data-translate")||i;return!e.hasAttribute("data-translate")&&i&&e.setAttribute("data-translate",t),ie(t)}function Y(e){e.querySelectorAll(".cya11y-card-title, .cya11y-translate").forEach(i=>{let t=i.textContent?.trim()||"";i.textContent=wi(i,t)}),A.querySelectorAll("[title]").forEach(i=>{let t=i.getAttribute("title")||"";i.setAttribute("title",wi(i,t))})}function z(e,i){if(e=String(e||"").toLowerCase(),F.some(t=>t.code===e)||(e=u.language.default),l.lang!==e){l.lang=e;let t=i.querySelector("#cya11y-language");t&&(t.value=e),Y(i),v()}}var xi='<svg viewbox="0 0 24 24" fill=none height=24 width=24 xmlns=http://www.w3.org/2000/svg><path d="M18 9L12 15L6 9" stroke=black stroke-linecap=round stroke-linejoin=round stroke-width=2 /></svg>';function we(e){if(!e||typeof e!="string")return console.warn("Invalid attribute name provided to getScriptDataAttribute:",e),null;let i=`data-cya11y-${e}`;try{let t=document.currentScript;return t?.hasAttribute(i)?t.getAttribute(i):document.querySelector(`[${i}]`)?.getAttribute(i)||null}catch(t){return console.error("Error getting script data attribute:",t),null}}var Ai=we("lang")||document.documentElement?.lang||navigator?.language||document.querySelector('meta[http-equiv="Content-Language"]')?.getAttribute("content");function T(){let e=Ai?.split(/[-_]/)?.[0]?.trim()||u.language.default;return F.some(t=>t.code===e)?e:u.language.default}F.some(e=>e.code===l.lang)||(l.lang=T());var J=!1,K=null;function $(e,i=""){let t=e.querySelector("#cya11y-language-dropdown"),a=F.filter(c=>c.label.toLowerCase().includes(i.toLowerCase())||c.code.toLowerCase().includes(i.toLowerCase())),n=a.findIndex(c=>c.code===l.lang);t.innerHTML=`
    <div class="cya11y-custom-select" role="combobox" aria-haspopup="listbox" aria-expanded="${J}">
      <div class="cya11y-selected-lang" id="cya11y-selected-lang" aria-label="Selected language" aria-controls="cya11y-lang-list" aria-haspopup="listbox" tabindex="0">
        ...
        <span class="cya11y-lang-label">${F.find(c=>c.code===l.lang)?.label}</span>
        <span class="cya11y-arrow" aria-hidden="true">
          ${xi}
        </span>
      </div>
      <div class="cya11y-dropdown-list" id="cya11y-lang-list" role="listbox" style="display:${J?"block":"none"};">
  ...
  `;let o=t.querySelector(".cya11y-selected-lang"),y=t.querySelector(".cya11y-dropdown-list"),m=t.querySelector(".cya11y-lang-search"),w=y.querySelector(".cya11y-lang-options"),V=n>=0?n:0;o.onclick=c=>{c.stopPropagation(),J?(N(t),o.querySelector(".cya11y-arrow")?.classList.remove("cya11y-arrow-rotate")):(xe(t),o.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),m?.focus())},o.onkeydown=c=>{(c.key==="Enter"||c.key===" "||c.key==="ArrowDown")&&(c.preventDefault(),xe(t),o.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),setTimeout(()=>m?.focus(),0))},m?.addEventListener("input",c=>{let h=m.value,C=t.querySelector(".cya11y-dropdown-list").querySelector(".cya11y-lang-options"),k=F.filter(g=>g.label.toLowerCase().includes(h.toLowerCase())||g.code.toLowerCase().includes(h.toLowerCase()));C.innerHTML=k.map((g,b)=>`
      <div class="cya11y-lang-option${g.code===l.lang?" selected":""}" role="option" aria-selected="${g.code===l.lang}" data-code="${g.code}" tabindex="-1" data-index="${b}">
        <span class="cya11y-lang-code">${g.code.toUpperCase()}</span>
        <span class="cya11y-lang-label">${g.label}</span>
      </div>
    `).join(""),Array.from(C.querySelectorAll(".cya11y-lang-option")).forEach((g,b)=>{g.onclick=d=>{d.stopPropagation(),z(g.dataset.code,e),N(t),$(e),o.focus()}})}),m?.addEventListener("keydown",c=>{if(c.key==="ArrowDown"){c.preventDefault();let h=Array.from(t.querySelectorAll(".cya11y-lang-option"));h[0].focus(),h.forEach((p,C)=>{p.addEventListener("keydown",k=>{k.key==="ArrowDown"?(k.preventDefault(),C<h.length-1&&h[C+1].focus()):k.key==="ArrowUp"?(k.preventDefault(),C>0?h[C-1].focus():m.focus()):k.key==="Enter"||k.key===" "?(k.preventDefault(),z(p.dataset.code,e),N(t),$(e),o.focus()):k.key==="Escape"&&(N(t),o.focus())})})}});let S=Array.from(t.querySelectorAll(".cya11y-lang-option"));S.forEach((c,h)=>{c.addEventListener("focus",()=>{c.setAttribute("aria-selected","true"),S.forEach(p=>{p!==c&&p.setAttribute("aria-selected","false")})}),c.addEventListener("click",()=>{z(c.dataset.code,e),N(t),$(e),o.focus()}),c.addEventListener("keydown",p=>{p.key==="ArrowDown"?(p.preventDefault(),h<S.length-1&&S[h+1].focus()):p.key==="ArrowUp"?(p.preventDefault(),h>0?S[h-1].focus():m.focus()):p.key==="Enter"||p.key===" "?(p.preventDefault(),z(c.dataset.code,e),N(t),$(e),o.focus()):p.key==="Escape"&&(N(t),o.focus())})}),m?.addEventListener("focus",()=>{xe(t)})}function N(e){let i=e.querySelector(".cya11y-dropdown-list"),t=e.querySelector(".cya11y-selected-lang");i&&(i.style.display="none"),t.querySelector(".cya11y-arrow")?.classList.remove("cya11y-arrow-rotate"),J=!1,K&&(document.removeEventListener("mousedown",K),K=null)}function xe(e){let i=e.querySelector(".cya11y-dropdown-list"),t=e.querySelector(".cya11y-selected-lang");i&&(i.style.display="block"),t.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),J=!0,K||(K=a=>{e.contains(a.target)},document.addEventListener("mousedown",K))}function Ia(){return window.innerWidth<768}function X(){return Ia()?"mobile":"desktop"}function Ae(e){let i=e.querySelectorAll('a[href], button:not([disabled]), textarea, input, select, [tabindex]:not([tabindex="-1"])'),t=i[0],a=i[i.length-1],n=()=>{let o=e.getRootNode();return o instanceof ShadowRoot?o.activeElement:document.activeElement};e.addEventListener("keydown",function(o){if(o.key==="Tab"){let y=n();o.shiftKey?y===t&&(o.preventDefault(),a.focus()):y===a&&(o.preventDefault(),t.focus())}})}function M(e){let i=document.getElementById("cya11y-menu-announcements");i&&(i.textContent=e,setTimeout(()=>{i.textContent=""},1e3))}function B(e,i){e.setAttribute("aria-pressed",i.toString()),i?e.classList.add("cya11y-selected"):e.classList.remove("cya11y-selected")}function Pa(e,i){let t=Array.from(i.parentElement?.querySelectorAll(".cya11y-btn")||[]),a=t.indexOf(i);switch(e.key){case"ArrowRight":case"ArrowDown":e.preventDefault();let n=(a+1)%t.length;t[n]?.focus();break;case"ArrowLeft":case"ArrowUp":e.preventDefault();let o=a===0?t.length-1:a-1;t[o]?.focus();break;case"Home":e.preventDefault(),t[0]?.focus();break;case"End":e.preventDefault(),t[t.length-1]?.focus();break}}function Na(e,i){let t=i.querySelector(".cya11y-menu-content");if(!t)return;let a=document.createDocumentFragment();for(;t.firstChild;)a.appendChild(t.firstChild);let n=Xt(()=>{t.innerHTML="",t.appendChild(a),t.scrollTop=0});t.appendChild(n),t.scrollTop=0}function He(){let e=X(),i=document.createElement("div");i.innerHTML=`<style id="cya11y-menu-css">${ki}</style>`+We;let t=i.querySelector(".cya11y-menu"),a=u?.position[e];a&&(t.setAttribute("data-position",a),a.includes("right")?(t.style.right="0px",t.style.left="auto"):a.includes("left")&&(t.style.left="0px",t.style.right="auto"));let n=f=>{f.key==="Escape"&&(f.preventDefault(),f.stopPropagation(),O(),document.removeEventListener("keydown",n))};document.addEventListener("keydown",n),t._escapeKeyHandler=n;let o=t.querySelector(".content"),y=t.querySelector(".tools"),m=t.querySelector(".contrast"),w=t.querySelector(".profiles");o&&(o.innerHTML=_(mi)),y&&(y.innerHTML=_(Ci,"cya11y-tools")),m&&(m.innerHTML=_(oi,"cya11y-filter")),w&&(w.innerHTML=_(vi,"cya11y-profile"));let V=t.querySelector(".cya11y-profile-card"),S=t.querySelector(".cya11y-profile-title"),c=t.querySelector(".cya11y-profile-items");c&&(c.style.display="none"),S&&S.addEventListener("click",()=>{let f=t.querySelector(".cya11y-profile-items"),g=f.style.display!=="none";f.style.display=g?"none":"grid",S.setAttribute("aria-expanded",(!g).toString()),V.querySelector(".cya11y-arrow")?.classList.toggle("cya11y-arrow-rotate"),M(g?"Accessibility profiles collapsed":"Accessibility profiles expanded")}),V.remove();let h=l?.states,p=Number(h?.fontSize)||1;if(p!=1){let f=t.querySelector(".cya11y-amount");f&&(f.innerHTML=`${(p*100).toFixed(0)}%`)}P(t),$(t);let C=i.querySelector(".cya11y-accessibility-statement-link"),k=u.modules.statement;return C&&(k.displayInWidget&&k.formData?.companyName?(C.removeAttribute("href"),C.setAttribute("role","button"),C.style.display="block",C.style.cursor="pointer",C.addEventListener("click",f=>{f.preventDefault(),Na(i,t)})):k.enabled?(C.href=k.url||"#",C.style.display="block"):C.style.display="none"),i.querySelectorAll(".cya11y-menu-close, .cya11y-overlay").forEach(f=>f.addEventListener("click",O)),i.querySelectorAll(".cya11y-menu-reset").forEach(f=>f.addEventListener("click",()=>{ve(t),M("All accessibility settings have been reset to default")})),t.querySelectorAll(".cya11y-plus, .cya11y-minus").forEach(f=>{let g=f;g.addEventListener("click",()=>{let d=l?.states?.fontSize||1;g.classList.contains("cya11y-minus")?d-=.1:d+=.1,d=Math.max(d,.1),d=Math.min(d,4),d=Number(d.toFixed(4));let Q=i.querySelector(".cya11y-amount");Q&&(Q.textContent=`${(d*100).toFixed(0)}%`),R(d),l.states.fontSize=d,v(),M(`Font size set to ${(d*100).toFixed(0)}%`)})}),t.querySelectorAll(".cya11y-btn").forEach(f=>{let g=f;g.addEventListener("keydown",b=>{Pa(b,g)}),g.addEventListener("click",()=>{let b=g.dataset.key;if(!b)return;let d=!g.classList.contains("cya11y-selected");if(g.classList.contains("cya11y-filter")){if(t.querySelectorAll(".cya11y-filter").forEach(D=>{B(D,!1)}),d&&B(g,!0),l.states.contrast===b){l.states.contrast=!1,v(),U(),M("Contrast filter disabled");return}l.states.contrast=d?b:!1,I(l.states.contrast),v(),H(),B(g,d);let oe=g.querySelector(".cya11y-translate")?.textContent||b;M(`${oe} contrast enabled`);return}if(g.classList.contains("cya11y-profile")){if(t.querySelectorAll(".cya11y-profile").forEach(D=>{B(D,!1)}),d&&B(g,!0),l.states[b]){l.states[b]=!1,v(),ne(b,t),M(`${b} profile disabled`);return}Object.keys(l.states).forEach(D=>{D.includes("profile")&&(l.states[D]=!1,v(),ne(D,t))}),v(),l.states[b]=!0,ke(b,t),v(),H(),B(g,d);let oe=g.querySelector(".cya11y-translate")?.textContent||b;M(`${oe} profile enabled`)}B(g,d),l.states[b]=d,H(),v();let Q=g.querySelector(".cya11y-translate")?.textContent||b;M(`${Q} ${d?"enabled":"disabled"}`)})}),A&&A.appendChild(i),Ae(t),t}var x;function Fe(){x?O():x=He(),Y(x)}var Hi=`
   ...
   `;var Fi=`<svg viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<svg viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
   ...
   `;var zi=`<svg  viewBox="0 0 20 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
`;var Ba=[{id:"default",icon:ze},{id:"accessibility",icon:Hi},{id:"assist",icon:Fi},{id:"wheel",icon:zi}],A=null,ji={"bottom-right":e=>({bottom:`${e.bottom}px`,right:`${e.right}px`,left:"auto"}),"top-left":e=>({top:`${e.top}px`,left:`${e.left}px`,bottom:"auto",right:"auto"}),"top-right":e=>({top:`${e.top}px`,right:`${e.right}px`,left:"auto",bottom:"auto"}),"bottom-left":e=>({bottom:`${e.bottom}px`,left:`${e.left}px`,right:"auto"})};function Ti(){let e=X(),{position:i,margins:t}=u,a=i[e],n=t[e],o=ji[a];return o?o(n):ji["bottom-left"](n)}function Va(e,i){switch(e.key){case"Enter":case" ":e.preventDefault(),Fe();break;case"Escape":let t=document.querySelector("#cya11y-container");if(t){let a=t.shadowRoot;if(a){let n=a.querySelector(".cya11y-menu");if(n&&n.style.display!=="none"){let o=n.querySelector(".cya11y-menu-close");o&&(o.click(),i.setAttribute("aria-expanded","false"))}}}break}}function Mi(){try{let e=X();if(!(e==="mobile"?u.status.mobile:u.status.desktop))return console.log(`Widget disabled for ${e} device`),null;let t=document.createElement("div");t.id="cya11y-container";let a=t.attachShadow({mode:"open"}),n=u.position[e],o=Ba.find(S=>S.id===u.iconId),y=T(),m=G[y][u.label];if(a.innerHTML=`
      <style id="cya11y-widget-css">${Ke}</style>
    ...
    `,A=a.querySelector(".cya11y-widget"),!A)throw new Error("Failed to find widget element");A.style.setProperty("--cya11y-primary-color",u.primaryColor),A.style.setProperty("--cya11y-size",`${u.iconSize}px`);let w=A.querySelector(".cya11y-menu-btn"),V=A.querySelector(".cya11y-widget-icon");return w&&V&&(Object.assign(w.style,Ti()),Object.assign(V.style,Ti()),w.addEventListener("click",S=>{S.preventDefault(),S.stopPropagation(),S.stopImmediatePropagation(),Fe(),setTimeout(()=>{let c=document.querySelector(".cya11y-container");if(c){let h=c.shadowRoot;if(h){let p=h.querySelector(".cya11y-menu");if(p){let C=p.style.display!=="none";w.setAttribute("aria-expanded",C.toString())}}}},10)}),w.addEventListener("keydown",S=>{Va(S,w)}),w.addEventListener("focus",()=>{w.classList.add("cya11y-focus-visible")}),w.addEventListener("blur",()=>{w.classList.remove("cya11y-focus-visible")})),document.body.insertBefore(t,document.body.firstChild),A}catch(e){return console.error("Failed to render widget:",e),null}}async function je(){try{await Se();let e=Ve();return Object.assign(l,e),l.lang||(l.lang=T()),q(),Mi(),{changeLanguage:z}}catch(e){return console.error("Failed to initialize accessibility widget:",e),{changeLanguage:z}}}function Te(){try{let e=document.documentElement;if(!e){console.warn("HTML element not found, cannot observe lang attribute");return}let i=new MutationObserver(t=>{try{for(let a of t)if(a.type==="attributes"&&a.attributeName==="lang"){let n=T();z(n,!0)}}catch(a){console.error("Error handling lang attribute mutation:",a)}});i.observe(e,{attributes:!0,attributeFilter:["lang"]}),window.__cya11y__langObserver=i}catch(e){console.error("Failed to observe HTML lang attribute:",e)}}async function Me(){try{(document.readyState==="complete"||document.readyState==="interactive")&&(document.removeEventListener("readystatechange",Me),await je(),we("disableObserveLang")||Te())}catch(e){console.error("Failed to initialize accessibility widget:",e)}}document.addEventListener("readystatechange",Me);(document.readyState==="complete"||document.readyState==="interactive")&&Me();})();
