...
`;var k1={status:{mobile:!0,desktop:!0},iconId:"default",iconSize:48,label:"Accessibility widget",heading:"Accessibility menu",position:{mobile:"bottom-right",desktop:"bottom-right"},language:{default:"en",selected:[]},margins:{desktop:{top:20,bottom:20,left:20,right:20},mobile:{top:20,bottom:20,left:20,right:20}},primaryColor:"#1863DC",modules:{color:{darkContrast:{enabled:!1},lightContrast:{enabled:!1},highContrast:{enabled:!1},highSaturation:{enabled:!1},lightSaturation:{enabled:!1},monochrome:{enabled:!1}},content:{highlightText:{enabled:!1},highlightLinks:{enabled:!1},dyslexicFont:{enabled:!0},letterSpacing:{enabled:!1},lineHeight:{enabled:!0},fontWeight:{enabled:!1}},statement:{enabled:!1,url:""}}},C=Object.assign(k1,window._cyA11yConfig);function G(){let e=w.style.display!=="none",t=w.getRootNode().querySelector(".cya11y-overlay");if(String(w.style.display)!=="none"||e){w.style.display="none",t.style.display="none",w._escapeKeyHandler&&(document.removeEventListener("keydown",w._escapeKeyHandler),delete w._escapeKeyHandler);let a=document.querySelector("#cya11y-container");if(a){let n=a.shadowRoot;if(n){let o=n.querySelector(".cya11y-menu-btn");o&&o.setAttribute("aria-expanded","false")}}}else{w.style.display="block",t.style.display="block";let a=document.querySelector("#cya11y-container");if(a){let n=a.shadowRoot;if(n){let o=n.querySelector(".cya11y-menu-btn");o&&o.setAttribute("aria-expanded","true")}}}}var Q={"seizure-safe-profile":{contrast:"low-saturation",tools:["stop-animations"]},"adhd-profile":{contrast:"high-saturation",tools:["stop-animations","readable-guide"]},"cognitive-disabilities-profile":{tools:["stop-animations","highlight-links","highlight-title"]}};function I(e){let i=l.states;if(i){let t=Array.from(e.querySelectorAll(".cya11y-btn"));Object.entries(i).forEach(([a,n])=>{if(n&&a!=="fontSize"){let o=a==="contrast"?i[a]:a,p=t.find(m=>m.dataset.key===o);p&&p.classList.add("cya11y-selected")}else{let o=t.find(p=>p.dataset.key===a);o&&o.classList.remove("cya11y-selected"),a==="contrast"&&e.querySelectorAll(".cya11y-filter").forEach(m=>{m.classList.remove("cya11y-selected")})}})}}function be(e,i){let t=Q[e];t&&(l.states.contrast=t.contrast,R(t.contrast),t.tools.forEach(a=>{l.states[a]=!0}),S(),A(),I(i))}function q(){document.getElementById("cya11y-filter-style")?.remove(),document.documentElement.classList.remove("cya11y-filter")}function ee(e,i){let t=Q[e];q(),l.states.contrast=!1,t.tools.forEach(a=>{l.states[a]=!1,S()}),A(),I(i)}var xa=Te({"../locales/am.json":()=>Promise.resolve().then(()=>r(pt())),"../locales/ar.json":()=>Promise.resolve().then(()=>r(ft())),"../locales/bg.json":()=>Promise.resolve().then(()=>r(Ct())),"../locales/bn.json":()=>Promise.resolve().then(()=>r(bt())),"../locales/ca.json":()=>Promise.resolve().then(()=>r(Lt())),"../locales/cs.json":()=>Promise.resolve().then(()=>r(St())),"../locales/da.json":()=>Promise.resolve().then(()=>r(vt())),"../locales/de.json":()=>Promise.resolve().then(()=>r(kt())),"../locales/el.json":()=>Promise.resolve().then(()=>r(wt())),"../locales/en.json":()=>Promise.resolve().then(()=>r(xt())),"../locales/es.json":()=>Promise.resolve().then(()=>r(At())),"../locales/fa.json":()=>Promise.resolve().then(()=>r(Ht())),"../locales/fi.json":()=>Promise.resolve().then(()=>r(Ft())),"../locales/fil.json":()=>Promise.resolve().then(()=>r(zt())),"../locales/fr.json":()=>Promise.resolve().then(()=>r(jt())),"../locales/he.json":()=>Promise.resolve().then(()=>r(Tt())),"../locales/hi.json":()=>Promise.resolve().then(()=>r(Mt())),"../locales/hr.json":()=>Promise.resolve().then(()=>r(Dt())),"../locales/hu.json":()=>Promise.resolve().then(()=>r(Et())),"../locales/id.json":()=>Promise.resolve().then(()=>r(Rt())),"../locales/it.json":()=>Promise.resolve().then(()=>r(It())),"../locales/ja.json":()=>Promise.resolve().then(()=>r(Pt())),"../locales/ka.json":()=>Promise.resolve().then(()=>r(Nt())),"../locales/kn.json":()=>Promise.resolve().then(()=>r(Bt())),"../locales/ko.json":()=>Promise.resolve().then(()=>r(Vt())),"../locales/ku.json":()=>Promise.resolve().then(()=>r(Zt())),"../locales/lb.json":()=>Promise.resolve().then(()=>r(Gt())),"../locales/lt.json":()=>Promise.resolve().then(()=>r(Ot())),"../locales/lv.json":()=>Promise.resolve().then(()=>r(_t())),"../locales/ml.json":()=>Promise.resolve().then(()=>r(Kt())),"../locales/mn.json":()=>Promise.resolve().then(()=>r($t())),"../locales/ms.json":()=>Promise.resolve().then(()=>r(Wt())),"../locales/my.json":()=>Promise.resolve().then(()=>r(qt())),"../locales/nb.json":()=>Promise.resolve().then(()=>r(Ut())),"../locales/nl.json":()=>Promise.resolve().then(()=>r(Yt())),"../locales/no.json":()=>Promise.resolve().then(()=>r(Jt())),"../locales/pa.json":()=>Promise.resolve().then(()=>r(Xt())),"../locales/pl.json":()=>Promise.resolve().then(()=>r(Qt())),"../locales/pt.json":()=>Promise.resolve().then(()=>r(ei())),"../locales/ro.json":()=>Promise.resolve().then(()=>r(ti())),"../locales/ru.json":()=>Promise.resolve().then(()=>r(ii())),"../locales/si.json":()=>Promise.resolve().then(()=>r(ai())),"../locales/sk.json":()=>Promise.resolve().then(()=>r(ni())),"../locales/sl.json":()=>Promise.resolve().then(()=>r(oi())),"../locales/sr.json":()=>Promise.resolve().then(()=>r(si())),"../locales/sv.json":()=>Promise.resolve().then(()=>r(ri())),"../locales/sw.json":()=>Promise.resolve().then(()=>r(li())),"../locales/ta.json":()=>Promise.resolve().then(()=>r(ci())),"../locales/te.json":()=>Promise.resolve().then(()=>r(gi())),"../locales/th.json":()=>Promise.resolve().then(()=>r(di())),"../locales/tr.json":()=>Promise.resolve().then(()=>r(ui())),"../locales/uk.json":()=>Promise.resolve().then(()=>r(yi())),"../locales/ur.json":()=>Promise.resolve().then(()=>r(mi())),"../locales/vi.json":()=>Promise.resolve().then(()=>r(hi())),"../locales/zh.json":()=>Promise.resolve().then(()=>r(pi()))});var H=[{code:"am",label:"\u12A0\u121B\u122D\u129B (Amharic)"},{code:"ar",label:"\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (Arabic)"},{code:"bg",label:"\u0431\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438 (Bulgarian)"},{code:"bn",label:"\u09AC\u09BE\u0982\u09B2\u09BE (Bengali)"},{code:"ca",label:"Catal\xE0 (Catalan)"},{code:"cs",label:"\u010De\u0161tina (Czech)"},{code:"da",label:"Danish (Denmark)"},{code:"de",label:"Deutsch (German)"},{code:"el",label:"\u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC (Greek)"},{code:"en",label:"English (English)"},{code:"es",label:"Espa\xF1ol (Spanish)"},{code:"fa",label:"\u0641\u0627\u0631\u0633\u06CC (Persian)"},{code:"fi",label:"suomi (Finnish)"},{code:"fil",label:"Tagalog (Filipno)"},{code:"fr",label:"Fran\xE7ais (French)"},{code:"he",label:"\u05E2\u05D1\u05E8\u05D9\u05EA (Hebrew)"},{code:"hi",label:"\u0939\u093F\u0928\u094D\u0926\u0940 (Hindi)"},{code:"hr",label:"Hrvatski (Croatian)"},{code:"hu",label:"Magyar (Hungarian)"},{code:"id",label:"Bahasa Indonesia (Indonesian)"},{code:"it",label:"Italiano (Italian)"},{code:"ja",label:"\u65E5\u672C\u8A9E (Japanese)"},{code:"ka",label:"\u10E5\u10D0\u10E0\u10D7\u10E3\u10DA\u10D8 (Georgian)"},{code:"kn",label:"\u0C95\u0CA8\u0CCD\u0CA8\u0CA1 (Kannada)"},{code:"ko",label:"\uD55C\uAD6D\uC5B4 (Korean)"},{code:"ku",label:"Kurd\xEE (Kurdish)"},{code:"lt",label:"Lietuvi\u0173 (Lithuanian)"},{code:"lv",label:"Latvie\u0161u (Latvian)"},{code:"lb",label:"L\xEBtzebuergesch (Luxembourgish)"},{code:"ml",label:"\u0D2E\u0D32\u0D2F\u0D3E\u0D33\u0D02 (Malayalam)"},{code:"mn",label:"\u041C\u043E\u043D\u0433\u043E\u043B (Mongolian)"},{code:"ms",label:"Bahasa Malaysia (Malay)"},{code:"my",label:"\u1019\u103C\u1014\u103A\u1019\u102C (Burmese)"},{code:"nb",label:"Norsk bokm\xE5l (Norwegian Bokm\xE5l)"},{code:"nl",label:"Nederlands (Dutch)"},{code:"no",label:"Norsk (Norwegian)"},{code:"pa",label:"\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40 (Punjabi)"},{code:"pl",label:"Polski (Polish)"},{code:"pt",label:"Portugu\xEAs (Portuguese)"},{code:"ro",label:"Rom\xE2n\u0103 (Romanian)"},{code:"ru",label:"\u0420\u0443\u0441\u0441\u043A\u0438\u0439 (Russian)"},{code:"si",label:"\u0DC3\u0DD2\u0D82\u0DC4\u0DBD (Sinhala)"},{code:"sk",label:"sloven\u010Dina (Slovak)"},{code:"sl",label:"sloven\u0161\u010Dina (Slovenian)"},{code:"sr",label:"Srpski (Serbian)"},{code:"sv",label:"Svenska (Swedish)"},{code:"sw",label:"Kiswahili (Swahili)"},{code:"ta",label:"\u0BA4\u0BAE\u0BBF\u0BB4\u0BCD (Tamil)"},{code:"te",label:"\u0C24\u0C46\u0C32\u0C41\u0C17\u0C41 (Telugu)"},{code:"th",label:"\u0E44\u0E17\u0E22 (Thai)"},{code:"tr",label:"T\xFCrk\xE7e (Turkish)"},{code:"uk",label:"\u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430 (Ukrainian)"},{code:"ur",label:"\u0627\u0631\u062F\u0648 (Urdu)"},{code:"vi",label:"Ti\u1EBFng Vi\u1EC7t (Vietnamese)"}],Aa=H.map(e=>e.code),O={},fi=!1,te=null;async function Le(){if(!fi)return te||(te=(async()=>{try{for(let e of Aa)O[e]=(await xa(`../locales/${e}.json`)).default;fi=!0}catch(e){throw console.error("Failed to load languages:",e),e}})(),te)}Le();function Ci(e){return(O[l.lang]??O[C.language.default])[e]??e}function bi(e,i){let t=e.getAttribute("data-translate")||i;return!e.hasAttribute("data-translate")&&i&&e.setAttribute("data-translate",t),Ci(t)}function U(e){e.querySelectorAll(".cya11y-card-title, .cya11y-translate").forEach(i=>{let t=i.textContent?.trim()||"";i.textContent=bi(i,t)}),x.querySelectorAll("[title]").forEach(i=>{let t=i.getAttribute("title")||"";i.setAttribute("title",bi(i,t))})}function F(e,i){if(e=String(e||"").toLowerCase(),H.some(t=>t.code===e)||(e=C.language.default),l.lang!==e){l.lang=e;let t=i.querySelector("#cya11y-language");t&&(t.value=e),U(i),S()}}var Li='<svg viewbox="0 0 24 24" fill=none height=24 width=24 xmlns=http://www.w3.org/2000/svg><path d="M18 9L12 15L6 9" stroke=black stroke-linecap=round stroke-linejoin=round stroke-width=2 /></svg>';function Se(e){if(!e||typeof e!="string")return console.warn("Invalid attribute name provided to getScriptDataAttribute:",e),null;let i=`data-cya11y-${e}`;try{let t=document.currentScript;return t?.hasAttribute(i)?t.getAttribute(i):document.querySelector(`[${i}]`)?.getAttribute(i)||null}catch(t){return console.error("Error getting script data attribute:",t),null}}var Si=Se("lang")||document.documentElement?.lang||navigator?.language||document.querySelector('meta[http-equiv="Content-Language"]')?.getAttribute("content");function j(){let e=Si?.split(/[-_]/)?.[0]?.trim()||C.language.default;return H.some(t=>t.code===e)?e:C.language.default}H.some(e=>e.code===l.lang)||(l.lang=j());var Y=!1,K=null;function _(e,i=""){let t=e.querySelector("#cya11y-language-dropdown"),a=H.filter(c=>c.label.toLowerCase().includes(i.toLowerCase())||c.code.toLowerCase().includes(i.toLowerCase())),n=a.findIndex(c=>c.code===l.lang);t.innerHTML=`
  ...
  `;let o=t.querySelector(".cya11y-selected-lang"),p=t.querySelector(".cya11y-dropdown-list"),m=t.querySelector(".cya11y-lang-search"),v=p.querySelector(".cya11y-lang-options"),B=n>=0?n:0;o.onclick=c=>{c.stopPropagation(),Y?(P(t),o.querySelector(".cya11y-arrow")?.classList.remove("cya11y-arrow-rotate")):(ve(t),o.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),m?.focus())},o.onkeydown=c=>{(c.key==="Enter"||c.key===" "||c.key==="ArrowDown")&&(c.preventDefault(),ve(t),o.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),setTimeout(()=>m?.focus(),0))},m?.addEventListener("input",c=>{let f=m.value,k=t.querySelector(".cya11y-dropdown-list").querySelector(".cya11y-lang-options"),g=H.filter(d=>d.label.toLowerCase().includes(f.toLowerCase())||d.code.toLowerCase().includes(f.toLowerCase()));k.innerHTML=g.map((d,u)=>`
    ...
    `).join(""),Array.from(k.querySelectorAll(".cya11y-lang-option")).forEach((d,u)=>{d.onclick=V=>{V.stopPropagation(),F(d.dataset.code,e),P(t),_(e),o.focus()}})}),m?.addEventListener("keydown",c=>{if(c.key==="ArrowDown"){c.preventDefault();let f=Array.from(t.querySelectorAll(".cya11y-lang-option"));f[0].focus(),f.forEach((h,k)=>{h.addEventListener("keydown",g=>{g.key==="ArrowDown"?(g.preventDefault(),k<f.length-1&&f[k+1].focus()):g.key==="ArrowUp"?(g.preventDefault(),k>0?f[k-1].focus():m.focus()):g.key==="Enter"||g.key===" "?(g.preventDefault(),F(h.dataset.code,e),P(t),_(e),o.focus()):g.key==="Escape"&&(P(t),o.focus())})})}});let L=Array.from(t.querySelectorAll(".cya11y-lang-option"));L.forEach((c,f)=>{c.addEventListener("focus",()=>{c.setAttribute("aria-selected","true"),L.forEach(h=>{h!==c&&h.setAttribute("aria-selected","false")})}),c.addEventListener("click",()=>{F(c.dataset.code,e),P(t),_(e),o.focus()}),c.addEventListener("keydown",h=>{h.key==="ArrowDown"?(h.preventDefault(),f<L.length-1&&L[f+1].focus()):h.key==="ArrowUp"?(h.preventDefault(),f>0?L[f-1].focus():m.focus()):h.key==="Enter"||h.key===" "?(h.preventDefault(),F(c.dataset.code,e),P(t),_(e),o.focus()):h.key==="Escape"&&(P(t),o.focus())})}),m?.addEventListener("focus",()=>{ve(t)})}function P(e){let i=e.querySelector(".cya11y-dropdown-list"),t=e.querySelector(".cya11y-selected-lang");i&&(i.style.display="none"),t.querySelector(".cya11y-arrow")?.classList.remove("cya11y-arrow-rotate"),Y=!1,K&&(document.removeEventListener("mousedown",K),K=null)}function ve(e){let i=e.querySelector(".cya11y-dropdown-list"),t=e.querySelector(".cya11y-selected-lang");i&&(i.style.display="block"),t.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),Y=!0,K||(K=a=>{e.contains(a.target)},document.addEventListener("mousedown",K))}function Fa(){return window.innerWidth<768}function J(){return Fa()?"mobile":"desktop"}function ke(e){let i=e.querySelectorAll('a[href], button:not([disabled]), textarea, input, select, [tabindex]:not([tabindex="-1"])'),t=i[0],a=i[i.length-1],n=()=>{let o=e.getRootNode();return o instanceof ShadowRoot?o.activeElement:document.activeElement};e.addEventListener("keydown",function(o){if(o.key==="Tab"){let p=n();o.shiftKey?p===t&&(o.preventDefault(),a.focus()):p===a&&(o.preventDefault(),t.focus())}})}function T(e){let i=document.getElementById("cya11y-menu-announcements");i&&(i.textContent=e,setTimeout(()=>{i.textContent=""},1e3))}function N(e,i){e.setAttribute("aria-pressed",i.toString()),i?e.classList.add("cya11y-selected"):e.classList.remove("cya11y-selected")}function za(e,i){let t=Array.from(i.parentElement?.querySelectorAll(".cya11y-btn")||[]),a=t.indexOf(i);switch(e.key){case"ArrowRight":case"ArrowDown":e.preventDefault();let n=(a+1)%t.length;t[n]?.focus();break;case"ArrowLeft":case"ArrowUp":e.preventDefault();let o=a===0?t.length-1:a-1;t[o]?.focus();break;case"Home":e.preventDefault(),t[0]?.focus();break;case"End":e.preventDefault(),t[t.length-1]?.focus();break}}function we(){let e=J(),i=document.createElement("div");i.innerHTML=`<style id="cya11y-menu-css">${ht}</style>`+_e;let t=i.querySelector(".cya11y-menu"),a=C?.position[e];a&&(t.setAttribute("data-position",a),a.includes("right")?(t.style.right="0px",t.style.left="auto"):a.includes("left")&&(t.style.left="0px",t.style.right="auto"));let n=g=>{g.key==="Escape"&&(g.preventDefault(),g.stopPropagation(),G(),document.removeEventListener("keydown",n))};document.addEventListener("keydown",n),t._escapeKeyHandler=n;let o=t.querySelector(".content"),p=t.querySelector(".tools"),m=t.querySelector(".contrast"),v=t.querySelector(".profiles");o&&(o.innerHTML=Z(st)),p&&(p.innerHTML=Z(gt,"cya11y-tools")),m&&(m.innerHTML=Z(Je,"cya11y-filter")),v&&(v.innerHTML=Z(mt,"cya11y-profile"));let B=t.querySelector(".cya11y-profile-card"),L=t.querySelector(".cya11y-profile-title"),c=t.querySelector(".cya11y-profile-items");c&&(c.style.display="none"),L&&L.addEventListener("click",()=>{let g=t.querySelector(".cya11y-profile-items"),y=g.style.display!=="none";g.style.display=y?"none":"grid",L.setAttribute("aria-expanded",(!y).toString()),B.querySelector(".cya11y-arrow")?.classList.toggle("cya11y-arrow-rotate"),T(y?"Accessibility profiles collapsed":"Accessibility profiles expanded")}),B.remove();let f=l?.states,h=Number(f?.fontSize)||1;if(h!=1){let g=t.querySelector(".cya11y-amount");g&&(g.innerHTML=`${(h*100).toFixed(0)}%`)}I(t),_(t);let k=i.querySelector(".cya11y-accessibility-statement-link");return k&&(C.modules.statement.enabled?(k.href=C.modules.statement.url||"#",k.style.display="block"):k.style.display="none"),i.querySelectorAll(".cya11y-menu-close, .cya11y-overlay").forEach(g=>g.addEventListener("click",G)),i.querySelectorAll(".cya11y-menu-reset").forEach(g=>g.addEventListener("click",()=>{Ce(t),T("All accessibility settings have been reset to default")})),t.querySelectorAll(".cya11y-plus, .cya11y-minus").forEach(g=>{let y=g;y.addEventListener("click",()=>{let u=l?.states?.fontSize||1;y.classList.contains("cya11y-minus")?u-=.1:u+=.1,u=Math.max(u,.1),u=Math.min(u,4),u=Number(u.toFixed(4));let V=i.querySelector(".cya11y-amount");V&&(V.textContent=`${(u*100).toFixed(0)}%`),E(u),l.states.fontSize=u,S(),T(`Font size set to ${(u*100).toFixed(0)}%`)})}),t.querySelectorAll(".cya11y-btn").forEach(g=>{let y=g;y.addEventListener("keydown",d=>{za(d,y)}),y.addEventListener("click",()=>{let d=y.dataset.key;if(!d)return;let u=!y.classList.contains("cya11y-selected");if(y.classList.contains("cya11y-filter")){if(t.querySelectorAll(".cya11y-filter").forEach(M=>{N(M,!1)}),u&&N(y,!0),l.states.contrast===d){l.states.contrast=!1,S(),q(),T("Contrast filter disabled");return}l.states.contrast=u?d:!1,R(l.states.contrast),S(),A(),N(y,u);let ie=y.querySelector(".cya11y-translate")?.textContent||d;T(`${ie} contrast enabled`);return}if(y.classList.contains("cya11y-profile")){if(t.querySelectorAll(".cya11y-profile").forEach(M=>{N(M,!1)}),u&&N(y,!0),l.states[d]){l.states[d]=!1,S(),ee(d,t),T(`${d} profile disabled`);return}Object.keys(l.states).forEach(M=>{M.includes("profile")&&(l.states[M]=!1,S(),ee(M,t))}),S(),l.states[d]=!0,be(d,t),S(),A(),N(y,u);let ie=y.querySelector(".cya11y-translate")?.textContent||d;T(`${ie} profile enabled`)}N(y,u),l.states[d]=u,A(),S();let V=y.querySelector(".cya11y-translate")?.textContent||d;T(`${V} ${u?"enabled":"disabled"}`)})}),x&&x.appendChild(i),ke(t),t}var w;function xe(){w?G():w=we(),U(w)}var vi=`
...
`;var ja=[{id:"default",icon:Ae},{id:"accessibility",icon:vi},{id:"assist",icon:ki},{id:"wheel",icon:wi}],x=null,xi={"bottom-right":e=>({bottom:`${e.bottom}px`,right:`${e.right}px`,left:"auto"}),"top-left":e=>({top:`${e.top}px`,left:`${e.left}px`,bottom:"auto",right:"auto"}),"top-right":e=>({top:`${e.top}px`,right:`${e.right}px`,left:"auto",bottom:"auto"}),"bottom-left":e=>({bottom:`${e.bottom}px`,left:`${e.left}px`,right:"auto"})};function Ai(){let e=J(),{position:i,margins:t}=C,a=i[e],n=t[e],o=xi[a];return o?o(n):xi["bottom-left"](n)}function Ta(e,i){switch(e.key){case"Enter":case" ":e.preventDefault(),xe();break;case"Escape":let t=document.querySelector("#cya11y-container");if(t){let a=t.shadowRoot;if(a){let n=a.querySelector(".cya11y-menu");if(n&&n.style.display!=="none"){let o=n.querySelector(".cya11y-menu-close");o&&(o.click(),i.setAttribute("aria-expanded","false"))}}}break}}function Hi(){try{let e=J();if(!(e==="mobile"?C.status.mobile:C.status.desktop))return console.log(`Widget disabled for ${e} device`),null;let t=document.createElement("div");t.id="cya11y-container";let a=t.attachShadow({mode:"open"}),n=C.position[e],o=ja.find(L=>L.id===C.iconId),p=j(),m=O[p][C.label];if(a.innerHTML=`
      <style id="cya11y-widget-css">${Oe}</style>
    ...
    `,x=a.querySelector(".cya11y-widget"),!x)throw new Error("Failed to find widget element");x.style.setProperty("--cya11y-primary-color",C.primaryColor),x.style.setProperty("--cya11y-size",`${C.iconSize}px`);let v=x.querySelector(".cya11y-menu-btn"),B=x.querySelector(".cya11y-widget-icon");return v&&B&&(Object.assign(v.style,Ai()),Object.assign(B.style,Ai()),v.addEventListener("click",L=>{L.preventDefault(),L.stopPropagation(),L.stopImmediatePropagation(),xe(),setTimeout(()=>{let c=document.querySelector(".cya11y-container");if(c){let f=c.shadowRoot;if(f){let h=f.querySelector(".cya11y-menu");if(h){let k=h.style.display!=="none";v.setAttribute("aria-expanded",k.toString())}}}},10)}),v.addEventListener("keydown",L=>{Ta(L,v)}),v.addEventListener("focus",()=>{v.classList.add("cya11y-focus-visible")}),v.addEventListener("blur",()=>{v.classList.remove("cya11y-focus-visible")})),document.body.insertBefore(t,document.body.firstChild),x}catch(e){return console.error("Failed to render widget:",e),null}}async function He(){try{await Le();let e=Pe();return Object.assign(l,e),l.lang||(l.lang=j()),W(),Hi(),{changeLanguage:F}}catch(e){return console.error("Failed to initialize accessibility widget:",e),{changeLanguage:F}}}function Fe(){try{let e=document.documentElement;if(!e){console.warn("HTML element not found, cannot observe lang attribute");return}let i=new MutationObserver(t=>{try{for(let a of t)if(a.type==="attributes"&&a.attributeName==="lang"){let n=j();F(n,!0)}}catch(a){console.error("Error handling lang attribute mutation:",a)}});i.observe(e,{attributes:!0,attributeFilter:["lang"]}),window.__cya11y__langObserver=i}catch(e){console.error("Failed to observe HTML lang attribute:",e)}}async function ze(){try{(document.readyState==="complete"||document.readyState==="interactive")&&(document.removeEventListener("readystatechange",ze),await He(),Se("disableObserveLang")||Fe())}catch(e){console.error("Failed to initialize accessibility widget:",e)}}document.addEventListener("readystatechange",ze);(document.readyState==="complete"||document.readyState==="interactive")&&ze();})();
