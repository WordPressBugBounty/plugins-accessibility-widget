...
`;var m1={status:{mobile:!0,desktop:!0},iconId:"default",iconSize:48,label:"Accessibility widget",heading:"Accessibility menu",position:{mobile:"bottom-right",desktop:"bottom-right"},language:{default:"en",selected:[]},margins:{desktop:{top:20,bottom:20,left:20,right:20},mobile:{top:20,bottom:20,left:20,right:20}},primaryColor:"#1863DC",modules:{color:{darkContrast:{enabled:!1},lightContrast:{enabled:!1},highContrast:{enabled:!1},highSaturation:{enabled:!1},lightSaturation:{enabled:!1},monochrome:{enabled:!1}},content:{highlightText:{enabled:!1},highlightLinks:{enabled:!1},dyslexicFont:{enabled:!0},letterSpacing:{enabled:!1},lineHeight:{enabled:!0},fontWeight:{enabled:!1}},statement:{enabled:!1,url:""}}},p=Object.assign(m1,window._cyA11yConfig);function O(){let e=k.style.display!=="none",t=k.getRootNode().querySelector(".cya11y-overlay");if(String(k.style.display)!=="none"||e){k.style.display="none",t.style.display="none",k._escapeKeyHandler&&(document.removeEventListener("keydown",k._escapeKeyHandler),delete k._escapeKeyHandler);let a=document.querySelector("#cya11y-container");if(a){let o=a.shadowRoot;if(o){let n=o.querySelector(".cya11y-menu-btn");n&&n.setAttribute("aria-expanded","false")}}}else{k.style.display="block",t.style.display="block";let a=document.querySelector("#cya11y-container");if(a){let o=a.shadowRoot;if(o){let n=o.querySelector(".cya11y-menu-btn");n&&n.setAttribute("aria-expanded","true")}}}}var ee={"seizure-safe-profile":{contrast:"low-saturation",tools:["stop-animations"]},"adhd-profile":{contrast:"high-saturation",tools:["stop-animations","readable-guide"]},"cognitive-disabilities-profile":{tools:["stop-animations","highlight-links","highlight-title"]}};function R(e){let i=l.states;if(i){let t=Array.from(e.querySelectorAll(".cya11y-btn"));Object.entries(i).forEach(([a,o])=>{if(o&&a!=="fontSize"){let n=a==="contrast"?i[a]:a,b=t.find(u=>u.dataset.key===n);b&&b.classList.add("cya11y-selected")}else{let n=t.find(b=>b.dataset.key===a);n&&n.classList.remove("cya11y-selected"),a==="contrast"&&e.querySelectorAll(".cya11y-filter").forEach(u=>{u.classList.remove("cya11y-selected")})}})}}function Ce(e,i){let t=ee[e];t&&(l.states.contrast=t.contrast,E(t.contrast),t.tools.forEach(a=>{l.states[a]=!0}),L(),A(),R(i))}function U(){document.getElementById("cya11y-filter-style")?.remove(),document.documentElement.classList.remove("cya11y-filter")}function te(e,i){let t=ee[e];U(),l.states.contrast=!1,t.tools.forEach(a=>{l.states[a]=!1,L()}),A(),R(i)}var ya=ze({"../locales/am.json":()=>Promise.resolve().then(()=>r(pt())),"../locales/ar.json":()=>Promise.resolve().then(()=>r(mt())),"../locales/bg.json":()=>Promise.resolve().then(()=>r(ht())),"../locales/bn.json":()=>Promise.resolve().then(()=>r(ft())),"../locales/ca.json":()=>Promise.resolve().then(()=>r(Ct())),"../locales/cs.json":()=>Promise.resolve().then(()=>r(bt())),"../locales/da.json":()=>Promise.resolve().then(()=>r(Lt())),"../locales/de.json":()=>Promise.resolve().then(()=>r(St())),"../locales/el.json":()=>Promise.resolve().then(()=>r(vt())),"../locales/en.json":()=>Promise.resolve().then(()=>r(kt())),"../locales/es.json":()=>Promise.resolve().then(()=>r(wt())),"../locales/fa.json":()=>Promise.resolve().then(()=>r(xt())),"../locales/fi.json":()=>Promise.resolve().then(()=>r(At())),"../locales/fil.json":()=>Promise.resolve().then(()=>r(Ht())),"../locales/fr.json":()=>Promise.resolve().then(()=>r(Ft())),"../locales/he.json":()=>Promise.resolve().then(()=>r(zt())),"../locales/hi.json":()=>Promise.resolve().then(()=>r(jt())),"../locales/hr.json":()=>Promise.resolve().then(()=>r(Mt())),"../locales/hu.json":()=>Promise.resolve().then(()=>r(Tt())),"../locales/id.json":()=>Promise.resolve().then(()=>r(Dt())),"../locales/it.json":()=>Promise.resolve().then(()=>r(Et())),"../locales/ja.json":()=>Promise.resolve().then(()=>r(Rt())),"../locales/ka.json":()=>Promise.resolve().then(()=>r(It())),"../locales/kn.json":()=>Promise.resolve().then(()=>r(Pt())),"../locales/ko.json":()=>Promise.resolve().then(()=>r(Nt())),"../locales/ku.json":()=>Promise.resolve().then(()=>r(Bt())),"../locales/lb.json":()=>Promise.resolve().then(()=>r(Zt())),"../locales/ml.json":()=>Promise.resolve().then(()=>r(Vt())),"../locales/mn.json":()=>Promise.resolve().then(()=>r(Gt())),"../locales/ms.json":()=>Promise.resolve().then(()=>r(Ot())),"../locales/my.json":()=>Promise.resolve().then(()=>r(_t())),"../locales/nl.json":()=>Promise.resolve().then(()=>r(Kt())),"../locales/no.json":()=>Promise.resolve().then(()=>r($t())),"../locales/pa.json":()=>Promise.resolve().then(()=>r(Wt())),"../locales/pl.json":()=>Promise.resolve().then(()=>r(qt())),"../locales/pt.json":()=>Promise.resolve().then(()=>r(Ut())),"../locales/ro.json":()=>Promise.resolve().then(()=>r(Yt())),"../locales/ru.json":()=>Promise.resolve().then(()=>r(Jt())),"../locales/si.json":()=>Promise.resolve().then(()=>r(Xt())),"../locales/sk.json":()=>Promise.resolve().then(()=>r(Qt())),"../locales/sl.json":()=>Promise.resolve().then(()=>r(ei())),"../locales/sr.json":()=>Promise.resolve().then(()=>r(ti())),"../locales/sv.json":()=>Promise.resolve().then(()=>r(ii())),"../locales/sw.json":()=>Promise.resolve().then(()=>r(ai())),"../locales/ta.json":()=>Promise.resolve().then(()=>r(oi())),"../locales/te.json":()=>Promise.resolve().then(()=>r(ni())),"../locales/th.json":()=>Promise.resolve().then(()=>r(si())),"../locales/tr.json":()=>Promise.resolve().then(()=>r(ri())),"../locales/ur.json":()=>Promise.resolve().then(()=>r(li())),"../locales/vi.json":()=>Promise.resolve().then(()=>r(ci())),"../locales/zh.json":()=>Promise.resolve().then(()=>r(gi()))});var H=[{code:"am",label:"\u12A0\u121B\u122D\u129B (Amharic)"},{code:"ar",label:"\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (Arabic)"},{code:"bg",label:"\u0431\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438 (Bulgarian)"},{code:"bn",label:"\u09AC\u09BE\u0982\u09B2\u09BE (Bengali)"},{code:"ca",label:"Catal\xE0 (Catalan)"},{code:"cs",label:"\u010De\u0161tina (Czech)"},{code:"da",label:"Danish (Denmark)"},{code:"de",label:"Deutsch (German)"},{code:"el",label:"\u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC (Greek)"},{code:"en",label:"English (English)"},{code:"es",label:"Espa\xF1ol (Spanish)"},{code:"fa",label:"\u0641\u0627\u0631\u0633\u06CC (Persian)"},{code:"fi",label:"suomi (Finnish)"},{code:"fil",label:"Tagalog (Filipno)"},{code:"fr",label:"Fran\xE7ais (French)"},{code:"he",label:"\u05E2\u05D1\u05E8\u05D9\u05EA (Hebrew)"},{code:"hi",label:"\u0939\u093F\u0928\u094D\u0926\u0940 (Hindi)"},{code:"hr",label:"Hrvatski (Croatian)"},{code:"hu",label:"Magyar (Hungarian)"},{code:"id",label:"Bahasa Indonesia (Indonesian)"},{code:"it",label:"Italiano (Italian)"},{code:"ja",label:"\u65E5\u672C\u8A9E (Japanese)"},{code:"ka",label:"\u10E5\u10D0\u10E0\u10D7\u10E3\u10DA\u10D8 (Georgian)"},{code:"kn",label:"\u0C95\u0CA8\u0CCD\u0CA8\u0CA1 (Kannada)"},{code:"ko",label:"\uD55C\uAD6D\uC5B4 (Korean)"},{code:"ku",label:"Kurd\xEE (Kurdish)"},{code:"lb",label:"L\xEBtzebuergesch (Luxembourgish)"},{code:"ml",label:"\u0D2E\u0D32\u0D2F\u0D3E\u0D33\u0D02 (Malayalam)"},{code:"mn",label:"\u041C\u043E\u043D\u0433\u043E\u043B (Mongolian)"},{code:"ms",label:"Bahasa Malaysia (Malay)"},{code:"my",label:"\u1019\u103C\u1014\u103A\u1019\u102C (Burmese)"},{code:"nl",label:"Nederlands (Dutch)"},{code:"no",label:"Norsk (Norwegian)"},{code:"pa",label:"\u0A2A\u0A70\u0A1C\u0A3E\u0A2C\u0A40 (Punjabi)"},{code:"pl",label:"Polski (Polish)"},{code:"pt",label:"Portugu\xEAs (Portuguese)"},{code:"ro",label:"Rom\xE2n\u0103 (Romanian)"},{code:"ru",label:"\u0420\u0443\u0441\u0441\u043A\u0438\u0439 (Russian)"},{code:"si",label:"Sloven\u0161\u010Dina (Slovene)"},{code:"sk",label:"sloven\u010Dina (Slovak)"},{code:"sl",label:"sloven\u0161\u010Dina (Slovenian)"},{code:"sr",label:"Srpski (Serbian)"},{code:"sv",label:"Svenska (Swedish)"},{code:"sw",label:"Kiswahili (Swahili)"},{code:"ta",label:"\u0BA4\u0BAE\u0BBF\u0BB4\u0BCD (Tamil)"},{code:"te",label:"\u0C24\u0C46\u0C32\u0C41\u0C17\u0C41 (Telugu)"},{code:"th",label:"\u0E44\u0E17\u0E22 (Thai)"},{code:"tr",label:"T\xFCrk\xE7e (Turkish)"},{code:"ur",label:"\u0627\u0631\u062F\u0648 (Urdu)"},{code:"vi",label:"Ti\u1EBFng Vi\u1EC7t (Vietnamese)"}],pa=H.map(e=>e.code),I={};async function ma(){for(let e of pa)I[e]=(await ya(`../locales/${e}.json`)).default}ma();function di(e){return(I[l.lang]??I[p.language.default])[e]??e}function ui(e,i){let t=e.getAttribute("data-translate")||i;return!e.hasAttribute("data-translate")&&i&&e.setAttribute("data-translate",t),di(t)}function Y(e){e.querySelectorAll(".cya11y-card-title, .cya11y-translate").forEach(i=>{let t=i.textContent?.trim()||"";i.textContent=ui(i,t)}),w.querySelectorAll("[title]").forEach(i=>{let t=i.getAttribute("title")||"";i.setAttribute("title",ui(i,t))})}function F(e,i){if(e=String(e||"").toLowerCase(),H.some(t=>t.code===e)||(e=p.language.default),l.lang!==e){l.lang=e;let t=i.querySelector("#cya11y-language");t&&(t.value=e),Y(i),L()}}var yi='<svg viewbox="0 0 24 24" fill=none height=24 width=24 xmlns=http://www.w3.org/2000/svg><path d="M18 9L12 15L6 9" stroke=black stroke-linecap=round stroke-linejoin=round stroke-width=2 /></svg>';function be(e){if(!e||typeof e!="string")return console.warn("Invalid attribute name provided to getScriptDataAttribute:",e),null;let i=`data-cya11y-${e}`;try{let t=document.currentScript;return t?.hasAttribute(i)?t.getAttribute(i):document.querySelector(`[${i}]`)?.getAttribute(i)||null}catch(t){return console.error("Error getting script data attribute:",t),null}}var _=be("lang")||document.documentElement?.lang||navigator?.language||document.querySelector('meta[http-equiv="Content-Language"]')?.getAttribute("content");function P(){let e=_?.split(/[-_]/)?.[0]?.trim()||p.language.default;return H.some(t=>t.code===e)?e:p.language.default}H.some(e=>e.code===l.lang)||(l.lang=P());var J=!1,$=null;function K(e,i=""){let t=e.querySelector("#cya11y-language-dropdown"),a=H.filter(c=>c.label.toLowerCase().includes(i.toLowerCase())||c.code.toLowerCase().includes(i.toLowerCase())),o=a.findIndex(c=>c.code===l.lang);t.innerHTML=`
  ...
  `;let n=t.querySelector(".cya11y-selected-lang"),b=t.querySelector(".cya11y-dropdown-list"),u=t.querySelector(".cya11y-lang-search"),Z=b.querySelector(".cya11y-lang-options"),x=o>=0?o:0;n.onclick=c=>{c.stopPropagation(),J?(N(t),n.querySelector(".cya11y-arrow")?.classList.remove("cya11y-arrow-rotate")):(Le(t),n.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),u?.focus())},n.onkeydown=c=>{(c.key==="Enter"||c.key===" "||c.key==="ArrowDown")&&(c.preventDefault(),Le(t),n.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),setTimeout(()=>u?.focus(),0))},u?.addEventListener("input",c=>{let h=u.value,v=t.querySelector(".cya11y-dropdown-list").querySelector(".cya11y-lang-options"),g=H.filter(d=>d.label.toLowerCase().includes(h.toLowerCase())||d.code.toLowerCase().includes(h.toLowerCase()));v.innerHTML=g.map((d,y)=>`
    ...
    `).join(""),Array.from(v.querySelectorAll(".cya11y-lang-option")).forEach((d,y)=>{d.onclick=V=>{V.stopPropagation(),F(d.dataset.code,e),N(t),K(e),n.focus()}})}),u?.addEventListener("keydown",c=>{if(c.key==="ArrowDown"){c.preventDefault();let h=Array.from(t.querySelectorAll(".cya11y-lang-option"));h[0].focus(),h.forEach((f,v)=>{f.addEventListener("keydown",g=>{g.key==="ArrowDown"?(g.preventDefault(),v<h.length-1&&h[v+1].focus()):g.key==="ArrowUp"?(g.preventDefault(),v>0?h[v-1].focus():u.focus()):g.key==="Enter"||g.key===" "?(g.preventDefault(),F(f.dataset.code,e),N(t),K(e),n.focus()):g.key==="Escape"&&(N(t),n.focus())})})}});let S=Array.from(t.querySelectorAll(".cya11y-lang-option"));S.forEach((c,h)=>{c.addEventListener("focus",()=>{c.setAttribute("aria-selected","true"),S.forEach(f=>{f!==c&&f.setAttribute("aria-selected","false")})}),c.addEventListener("click",()=>{F(c.dataset.code,e),N(t),K(e),n.focus()}),c.addEventListener("keydown",f=>{f.key==="ArrowDown"?(f.preventDefault(),h<S.length-1&&S[h+1].focus()):f.key==="ArrowUp"?(f.preventDefault(),h>0?S[h-1].focus():u.focus()):f.key==="Enter"||f.key===" "?(f.preventDefault(),F(c.dataset.code,e),N(t),K(e),n.focus()):f.key==="Escape"&&(N(t),n.focus())})}),u?.addEventListener("focus",()=>{Le(t)})}function N(e){let i=e.querySelector(".cya11y-dropdown-list"),t=e.querySelector(".cya11y-selected-lang");i&&(i.style.display="none"),t.querySelector(".cya11y-arrow")?.classList.remove("cya11y-arrow-rotate"),J=!1,$&&(document.removeEventListener("mousedown",$),$=null)}function Le(e){let i=e.querySelector(".cya11y-dropdown-list"),t=e.querySelector(".cya11y-selected-lang");i&&(i.style.display="block"),t.querySelector(".cya11y-arrow")?.classList.add("cya11y-arrow-rotate"),J=!0,$||($=a=>{e.contains(a.target)},document.addEventListener("mousedown",$))}function fa(){return window.innerWidth<768}function X(){return fa()?"mobile":"desktop"}function Se(e){let i=e.querySelectorAll('a[href], button:not([disabled]), textarea, input, select, [tabindex]:not([tabindex="-1"])'),t=i[0],a=i[i.length-1],o=()=>{let n=e.getRootNode();return n instanceof ShadowRoot?n.activeElement:document.activeElement};e.addEventListener("keydown",function(n){if(n.key==="Tab"){let b=o();n.shiftKey?b===t&&(n.preventDefault(),a.focus()):b===a&&(n.preventDefault(),t.focus())}})}function j(e){let i=document.getElementById("cya11y-menu-announcements");i&&(i.textContent=e,setTimeout(()=>{i.textContent=""},1e3))}function B(e,i){e.setAttribute("aria-pressed",i.toString()),i?e.classList.add("cya11y-selected"):e.classList.remove("cya11y-selected")}function Ca(e,i){let t=Array.from(i.parentElement?.querySelectorAll(".cya11y-btn")||[]),a=t.indexOf(i);switch(e.key){case"ArrowRight":case"ArrowDown":e.preventDefault();let o=(a+1)%t.length;t[o]?.focus();break;case"ArrowLeft":case"ArrowUp":e.preventDefault();let n=a===0?t.length-1:a-1;t[n]?.focus();break;case"Home":e.preventDefault(),t[0]?.focus();break;case"End":e.preventDefault(),t[t.length-1]?.focus();break}}function ve(){let e=X(),i=document.createElement("div");i.innerHTML=`<style id="cya11y-menu-css">${yt}</style>`+Ge;let t=i.querySelector(".cya11y-menu"),a=p?.position[e];a&&(t.setAttribute("data-position",a),a.includes("right")?(t.style.right="0px",t.style.left="auto"):a.includes("left")&&(t.style.left="0px",t.style.right="auto"));let o=g=>{g.key==="Escape"&&(g.preventDefault(),g.stopPropagation(),O(),document.removeEventListener("keydown",o))};document.addEventListener("keydown",o),t._escapeKeyHandler=o;let n=t.querySelector(".content"),b=t.querySelector(".tools"),u=t.querySelector(".contrast"),Z=t.querySelector(".profiles");n&&(n.innerHTML=G(ot)),b&&(b.innerHTML=G(lt,"cya11y-tools")),u&&(u.innerHTML=G(Ue,"cya11y-filter")),Z&&(Z.innerHTML=G(ut,"cya11y-profile"));let x=t.querySelector(".cya11y-profile-card"),S=t.querySelector(".cya11y-profile-title"),c=t.querySelector(".cya11y-profile-items");c&&(c.style.display="none"),S&&S.addEventListener("click",()=>{let g=t.querySelector(".cya11y-profile-items"),m=g.style.display!=="none";g.style.display=m?"none":"grid",S.setAttribute("aria-expanded",(!m).toString()),x.querySelector(".cya11y-arrow")?.classList.toggle("cya11y-arrow-rotate"),j(m?"Accessibility profiles collapsed":"Accessibility profiles expanded")}),x.remove();let h=l?.states,f=Number(h?.fontSize)||1;if(f!=1){let g=t.querySelector(".cya11y-amount");g&&(g.innerHTML=`${(f*100).toFixed(0)}%`)}R(t),K(t);let v=i.querySelector(".cya11y-accessibility-statement-link");return v&&(p.modules.statement.enabled?(v.href=p.modules.statement.url||"#",v.style.display="block"):v.style.display="none"),i.querySelectorAll(".cya11y-menu-close, .cya11y-overlay").forEach(g=>g.addEventListener("click",O)),i.querySelectorAll(".cya11y-menu-reset").forEach(g=>g.addEventListener("click",()=>{fe(t),j("All accessibility settings have been reset to default")})),t.querySelectorAll(".cya11y-plus, .cya11y-minus").forEach(g=>{let m=g;m.addEventListener("click",()=>{let y=l?.states?.fontSize||1;m.classList.contains("cya11y-minus")?y-=.1:y+=.1,y=Math.max(y,.1),y=Math.min(y,4),y=Number(y.toFixed(4));let V=i.querySelector(".cya11y-amount");V&&(V.textContent=`${(y*100).toFixed(0)}%`),D(y),l.states.fontSize=y,L(),j(`Font size set to ${(y*100).toFixed(0)}%`)})}),t.querySelectorAll(".cya11y-btn").forEach(g=>{let m=g;m.addEventListener("keydown",d=>{Ca(d,m)}),m.addEventListener("click",()=>{let d=m.dataset.key;if(!d)return;let y=!m.classList.contains("cya11y-selected");if(m.classList.contains("cya11y-filter")){if(t.querySelectorAll(".cya11y-filter").forEach(M=>{B(M,!1)}),y&&B(m,!0),l.states.contrast===d){l.states.contrast=!1,L(),U(),j("Contrast filter disabled");return}l.states.contrast=y?d:!1,E(l.states.contrast),L(),A(),B(m,y);let ie=m.querySelector(".cya11y-translate")?.textContent||d;j(`${ie} contrast enabled`);return}if(m.classList.contains("cya11y-profile")){if(t.querySelectorAll(".cya11y-profile").forEach(M=>{B(M,!1)}),y&&B(m,!0),l.states[d]){l.states[d]=!1,L(),te(d,t),j(`${d} profile disabled`);return}Object.keys(l.states).forEach(M=>{M.includes("profile")&&(l.states[M]=!1,L(),te(M,t))}),L(),l.states[d]=!0,Ce(d,t),L(),A(),B(m,y);let ie=m.querySelector(".cya11y-translate")?.textContent||d;j(`${ie} profile enabled`)}B(m,y),l.states[d]=y,A(),L();let V=m.querySelector(".cya11y-translate")?.textContent||d;j(`${V} ${y?"enabled":"disabled"}`)})}),w&&w.appendChild(i),Se(t),t}var k;function ke(){k?O():k=ve(),Y(k)}var pi=`
...
`;var ba=[{id:"default",icon:we},{id:"accessibility",icon:pi},{id:"assist",icon:mi},{id:"wheel",icon:hi}],w=null,fi={"bottom-right":e=>({bottom:`${e.bottom}px`,right:`${e.right}px`,left:"auto"}),"top-left":e=>({top:`${e.top}px`,left:`${e.left}px`,bottom:"auto"}),"top-right":e=>({top:`${e.top}px`,right:`${e.right}px`,left:"auto",bottom:"auto"}),"bottom-left":e=>({bottom:`${e.bottom}px`,left:`${e.left}px`})};function Ci(){let e=X(),{position:i,margins:t}=p,a=i[e],o=t[e],n=fi[a];return n?n(o):fi["bottom-left"](o)}function La(e,i){switch(e.key){case"Enter":case" ":e.preventDefault(),ke();break;case"Escape":let t=document.querySelector("#cya11y-container");if(t){let a=t.shadowRoot;if(a){let o=a.querySelector(".cya11y-menu");if(o&&o.style.display!=="none"){let n=o.querySelector(".cya11y-menu-close");n&&(n.click(),i.setAttribute("aria-expanded","false"))}}}break}}function bi(){try{let e=X();if(!(e==="mobile"?p.status.mobile:p.status.desktop))return console.log(`Widget disabled for ${e} device`),null;let t=document.createElement("div");t.id="cya11y-container";let a=t.attachShadow({mode:"open"}),o=p.position[e],n=ba.find(x=>x.id===p.iconId),b=I[_?.split("-")[0]??p.language.default][p.label];if(console.log(b,"lable"),console.log(p.label,"pluginConfig.label"),console.log(_,"detectedLanguage"),console.log(p.language.default,"pluginConfig.language.default"),console.log(I[_?.split("-")[0]??p.language.default],"LANGUAGE_DICTIONARY"),a.innerHTML=`
      <style id="cya11y-widget-css">${Ve}</style>
    ...
    `,w=a.querySelector(".cya11y-widget"),!w)throw new Error("Failed to find widget element");w.style.setProperty("--cya11y-primary-color",p.primaryColor),w.style.setProperty("--cya11y-size",`${p.iconSize}px`);let u=w.querySelector(".cya11y-menu-btn"),Z=w.querySelector(".cya11y-widget-icon");return u&&Z&&(Object.assign(u.style,Ci()),Object.assign(Z.style,Ci()),u.addEventListener("click",x=>{x.preventDefault(),x.stopPropagation(),x.stopImmediatePropagation(),ke(),setTimeout(()=>{let S=document.querySelector(".cya11y-container");if(S){let c=S.shadowRoot;if(c){let h=c.querySelector(".cya11y-menu");if(h){let f=h.style.display!=="none";u.setAttribute("aria-expanded",f.toString())}}}},10)}),u.addEventListener("keydown",x=>{La(x,u)}),u.addEventListener("focus",()=>{u.classList.add("cya11y-focus-visible")}),u.addEventListener("blur",()=>{u.classList.remove("cya11y-focus-visible")})),document.body.insertBefore(t,document.body.firstChild),w}catch(e){return console.error("Failed to render widget:",e),null}}function xe(){try{let e=Re();return console.log("Default language:",P()),Object.assign(l,e),l.lang||(l.lang=P()),q(),bi(),{changeLanguage:F}}catch(e){return console.error("Failed to initialize accessibility widget:",e),{changeLanguage:F}}}function Ae(){try{let e=document.documentElement;if(!e){console.warn("HTML element not found, cannot observe lang attribute");return}let i=new MutationObserver(t=>{try{for(let a of t)if(a.type==="attributes"&&a.attributeName==="lang"){let o=P();F(o,!0)}}catch(a){console.error("Error handling lang attribute mutation:",a)}});i.observe(e,{attributes:!0,attributeFilter:["lang"]}),window.__cya11y__langObserver=i}catch(e){console.error("Failed to observe HTML lang attribute:",e)}}function He(){try{(document.readyState==="complete"||document.readyState==="interactive")&&(document.removeEventListener("readystatechange",He),xe(),be("disableObserveLang")||Ae())}catch(e){console.error("Failed to initialize accessibility widget:",e)}}document.addEventListener("readystatechange",He);(document.readyState==="complete"||document.readyState==="interactive")&&He();})();
